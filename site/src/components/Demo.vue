...
function handleOnClickOpenModal() {
  modal.open({
    ...
    content: `This action is so important that you are required to confirm it with a modal. Please click
...
function handleDeleteAccount() {
  modal.open({
    ...
    content: `Are you sure you want to delete your profile? This action is destructive and you will have to contact support to restore your data.`,
    type: "confirm",
    actions: [
      {
        title: "No dont't delete it",
        action: () => modal.close(),
        variant: "default",
      },
      {
...
<template>
  <div class="m-6">
    <Btn color="danger" @click="handleDeleteAccount">Delete your account</Btn>
  </div>
  <div class="m-6">
    <Btn @click="handleOnClickOpenModal">Open Confirm Modal</Btn>
  </div>
  <ModalManager />
  <div class="m-6">
    <Pagination

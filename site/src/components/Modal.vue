...
import { computed, Teleport, toRefs } from "vue";
import {
  Dialog,
  DialogOverlay,
  DialogTitle,
            ...
            >
              <slot name="header">
                <div
                  v-if="title"
                  :class="[
                    showDividers ? 'border-b px-4  py-3' : 'px-6  pt-5 pb-3',
                ...
                >
                  <div class="flex justify-between items-center">
                    ...
                    <a
                      ...
                      @click="emit('close')"
                      class="h-7 w-7 text-gray-700 dark:text-gray-100 hover:bg-opacity-40 flex items-center justify-center rounded-sm cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800"
                      ><svg
                        viewBox="0 0 15 15"
                        fill="none"
